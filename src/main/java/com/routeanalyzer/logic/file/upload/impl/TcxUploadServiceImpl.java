...
@Service
public class TcxUploadServiceImpl implements UploadService {

    private TCXService tcxService;
    private ActivityUtils activityUtils;
    private LapsUtils lapsUtils;

    public TcxUploadServiceImpl(TCXService tcxService, ActivityUtils activityUtils, LapsUtils lapsUtils) {
