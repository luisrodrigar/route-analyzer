...
@Service
public class GpxUploadServiceImpl implements UploadService {

    private GPXService gpxService;
    private ActivityUtils activityUtils;
    private LapsUtils lapsUtils;

    public GpxUploadServiceImpl(GPXService gpxService, ActivityUtils activityUtils, LapsUtils lapsUtils) {
